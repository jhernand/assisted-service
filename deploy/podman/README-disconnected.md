...
The values for the imageDigestSources[^icsp_deprecated] will be based on the output of the OpenShift mirror command that you used. See the "imageMirrorDigestSet.yaml" file that is generated after the successful creation of a mirror for the exact information that should go here.
