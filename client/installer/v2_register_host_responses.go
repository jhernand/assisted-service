...
// NewV2RegisterHostGone creates a V2RegisterHostGone with default headers values
func NewV2RegisterHostGone() *V2RegisterHostGone {
	return &V2RegisterHostGone{}
}

/*
V2RegisterHostGone describes a response with status code 410, with default header values.
...
// IsSuccess returns true when this v2 register host gone response has a 2xx status code
func (o *V2RegisterHostGone) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this v2 register host gone response has a 3xx status code
func (o *V2RegisterHostGone) IsRedirect() bool {
	return false
}

// IsClientError returns true when this v2 register host gone response has a 4xx status code
func (o *V2RegisterHostGone) IsClientError() bool {
	return true
}

// IsServerError returns true when this v2 register host gone response has a 5xx status code
func (o *V2RegisterHostGone) IsServerError() bool {
	return false
}

// IsCode returns true when this v2 register host gone response a status code equal to that given
func (o *V2RegisterHostGone) IsCode(code int) bool {
	return code == 410
}

func (o *V2RegisterHostGone) Error() string {
	return fmt.Sprintf("[POST /v2/infra-envs/{infra_env_id}/hosts][%d] v2RegisterHostGone  %+v", 410, o.Payload)
}

func (o *V2RegisterHostGone) String() string {
	return fmt.Sprintf("[POST /v2/infra-envs/{infra_env_id}/hosts][%d] v2RegisterHostGone  %+v", 410, o.Payload)
}

func (o *V2RegisterHostGone) GetPayload() *models.Error {
	return o.Payload
}

func (o *V2RegisterHostGone) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
